...
def sub_strings_multiple(word, dictionary)
  word.split(" ")
...
test_dictionary = ["below","down","go","going","horn","how","howdy","it","i","low","own","part","partner","sit","below","down","go","going","horn","how","howdy","it","i","low","own","part","partner","sit"]

#puts sub_strings_multiple("Howdy partner, sit down!, How's it going?", test_dictionary)
puts sub_strings(test_word_one, test_dictionary)